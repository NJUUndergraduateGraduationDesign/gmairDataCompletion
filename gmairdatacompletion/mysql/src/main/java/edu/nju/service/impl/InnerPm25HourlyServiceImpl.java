...
@Transactional
@Service
public class InnerPm25HourlyServiceImpl extends BaseDailyHourlyServiceImpl<InnerPm25Daily> implements InnerPm25HourlyService {
    @Resource
    private InnerPm25HourlyDao innerPm25HourlyDaoImpl;

    @Resource
    public void setDao(BaseDailyHourlyDao<InnerPm25Daily> innerPm25HourlyDao) {
