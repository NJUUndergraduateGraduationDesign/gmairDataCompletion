...
@Repository
public class VolumeDailyDaoImpl extends BaseDailyHourlyDaoImpl<VolumeDaily> implements VolumeDailyDao {
    @Override
    public List<Double> getAverageList(String uid, int methodCode, long startTime, long endTime) {
        String hql = "SELECT o.averageVolume FROM VolumeDaily o "
